                ...
                <div class="rd-navbar-right rd-navbar-nav-wrap">
                  <div class="rd-navbar-aside">
                    <ul class="rd-navbar-contacts-2">
                      <li class="mr-5 float-left"><span class="customLink" data-multitoggle=".rd-navbar-inner" data-multitoggle-blur=".rd-navbar-wrap" data-multitoggle-isolate>Login</span> | <span class="customLink" data-multitoggle=".rd-navbar-inner" data-multitoggle-blur=".rd-navbar-wrap" data-multitoggle-isolate>Register</span></li>
                      <li>
                    ...
                    <div>
                      <div class="row gutters-20 ml-5" data-lightgallery="group">
                        <form action="" method="POST" role="form" id="formLogin">
                          ...
                          <button type="submit" class="button button-sm btn-block button-primary-gradient" name="loginForm">Submit</button>
        ...
        <div class="container container-style-1">
          <div class="owl-carousel owl-style-12" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30" data-xl-margin="45" data-autoplay="true" data-nav="true" data-center="true" data-smart-speed="400">
            ...
            <article class="quote-tara">
              <div class="quote-tara-caption">
                <div class="quote-tara-text">
                  <p class="q">Your agency has been a great help for my admission and university welcome support. You did an excellent job!</p>
                </div>
                <div class="quote-tara-figure"><img src="images/user-6-115x115.jpg" alt="" width="115" height="115"/>
                </div>
              </div>
              <h6 class="quote-tara-author">Lillian Johnson</h6>
            ...
            <article class="quote-tara">
              <div class="quote-tara-caption">
                <div class="quote-tara-text">
                  <p class="q">I would just like to thank you for your effective online student support, for your friendly and professional support and answers to my questions!</p>
                </div>
                <div class="quote-tara-figure"><img src="images/user-7-115x115.jpg" alt="" width="115" height="115"/>
                </div>
              </div>
              <h6 class="quote-tara-author">Sam Fitzgerald</h6>
              <div class="quote-tara-status">Student (Germany)</div>
            </article>
            <!-- Quote Tara-->
            <article class="quote-tara">
              <div class="quote-tara-caption">
                <div class="quote-tara-text">
                  <p class="q">Thank you for my admission to Keele University. You provided all necessary support to improvem my chance of asmission and I appreciate it.</p>
                </div>
              ...
              <div class="quote-tara-status">Student (Australia)</div>
            </article>
            <!-- Quote Tara-->
            <article class="quote-tara">
              <div class="quote-tara-caption">
                <div class="quote-tara-text">
                  <p class="q">Your agency has been a great help to me as an international student. Your team effort is appreciated and I will definitely refer more friends.</p>
                </div>
                <div class="quote-tara-figure"><img src="images/user-6-115x115.jpg" alt="" width="115" height="115"/>
                </div>
              </div>
              <h6 class="quote-tara-author">Jane Mtuagan</h6>
              <div class="quote-tara-status">Student (South Africa)</div>
            </article>
          </div>
        </div>
      </section>
